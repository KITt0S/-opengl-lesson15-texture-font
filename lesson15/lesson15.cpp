...
int DrawGLScene(GLvoid)									// Here's Where We Do All The Drawing
{
	...
	glTranslatef(0.5f*float(cos(rot/16.0f)),0.5f*float(sin(rot/16.0f)),-3.0f);					// Move Left 1.5 Units And Into The Screen 6.0

	glRotatef(rot, 1.0f, 0.0f, 0.0f);
	glRotatef(1.2f*rot, 0.0f, 1.0f, 0.0f);
	glRotatef(1.4f*rot, 0.0f, 0.0f, 1.0f);
